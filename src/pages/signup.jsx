  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://financial-risk-analyzer.onrender.com/api/auth/register",
        {
          method: "POST",
      ...
      <div className="auth-panel">
        ...
        <div className="auth-heading">
          ...
          <p className="auth-heading__desc">
            Register your analyst profile to get started.
          </p>
        </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            <div className="auth-row">
              <div className="auth-field">
                <label className="auth-field__label" htmlFor="firstName">
                  First Name
                </label>
              ...
              <div className="auth-field">
                <label className="auth-field__label" htmlFor="lastName">
                  Last Name
                </label>
                <div className="auth-field__wrapper">
                  <input
            ...
            <div className="auth-field">
              ...
              <div className="auth-field__wrapper">
                <input
                  ...
                  type="email"
                  className="auth-field__input"
                  placeholder="john.doe@barclays.com"
            ...
            <div className="auth-field">
              <label className="auth-field__label" htmlFor="role">
                Role
              </label>
              <div className="auth-field__wrapper">
                <select
